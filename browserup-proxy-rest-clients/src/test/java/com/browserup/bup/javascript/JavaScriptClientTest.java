...
public class JavaScriptClientTest extends WithRunningProxyRestTest {
    ...
    public void connectToProxy() throws Exception {
        ...
        Assert.assertEquals("Expected javascript-client container exit code to be 0", 0,
    ...
    public void failsToConnectToProxy() throws Exception {
        ...
        Assert.assertEquals("Expected javascript-client container exit code to be 1", 1,
                (int) container.getCurrentContainerInfo().getState().getExitCode());
    }
}
