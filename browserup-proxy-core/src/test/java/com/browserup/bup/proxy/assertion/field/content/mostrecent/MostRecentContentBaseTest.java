...
public class MostRecentContentBaseTest extends ContentBaseTest {
    ...
    protected void mockAndSendRequestsToMockedServer(String recentBody, String oldBody) throws IOException,
