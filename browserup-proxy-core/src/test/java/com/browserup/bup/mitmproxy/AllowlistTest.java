...
public class AllowlistTest extends MockServerTest {
    ...
    public void testAllowlistCannotShortCircuitCONNECT() {
        ...
        AllowlistFilter filter = new AllowlistFilter(request, mockCtx, true, 500, Collections.emptyList());
    ...
    public void testNonAllowlistedHttpRequestReturnsAllowlistStatusCode() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("http://localhost/.*"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse response = client.execute(new HttpGet("http://www.someother.domain/someresource"));
    ...
    public void testNonAllowlistedHttpsRequestReturnsAllowlistStatusCode() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("https://some-other-domain/.*"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse response = client.execute(new HttpGet("https://localhost:" + mockServerHttpsPort + "/nonallowlistedresource"));
            assertEquals("Did not receive allowlist status code in response", 500, response.getStatusLine().getStatusCode());
    ...
    public void testAllowlistedHttpRequestNotShortCircuited() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("http://localhost:" + mockServerPort + "/.*"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse response = client.execute(new HttpGet("http://localhost:" + mockServerPort + "/allowlistedresource"));
    ...
    public void testAllowlistedHttpsRequestNotShortCircuited() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("https://localhost:" + mockServerHttpsPort + "/.*"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse response = client.execute(new HttpGet("https://localhost:" + mockServerHttpsPort + "/allowlistedresource"));
            assertEquals("Did not receive expected response from mock server for allowlisted url", 200, response.getStatusLine().getStatusCode());
    ...
    public void testCanAllowlistSpecificHttpResource() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("http://localhost:" + mockServerPort + "/allowlistedresource"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse nonAllowlistedResponse = client.execute(new HttpGet("http://localhost:" + mockServerPort + "/nonallowlistedresource"));
            ...
            CloseableHttpResponse allowlistedResponse = client.execute(new HttpGet("http://localhost:" + mockServerPort + "/allowlistedresource"));
    ...
    public void testCanAllowlistSpecificHttpsResource() throws Exception {
        ...
        proxy.allowlistRequests(Arrays.asList("https://localhost:" + mockServerHttpsPort + "/allowlistedresource"), 500);

        try (CloseableHttpClient client = NewProxyServerTestUtil.getNewHttpClient(proxyPort)) {
            CloseableHttpResponse nonAllowlistedResponse = client.execute(new HttpGet("https://localhost:" + mockServerHttpsPort + "/nonallowlistedresource"));
            assertEquals("Did not receive allowlist status code in response", 500, nonAllowlistedResponse.getStatusLine().getStatusCode());

            String nonAllowlistedResponseBody = NewProxyServerTestUtil.toStringAndClose(nonAllowlistedResponse.getEntity().getContent());
            assertThat("Expected allowlist response to contain 0-length body", nonAllowlistedResponseBody, is(emptyOrNullString()));

            CloseableHttpResponse allowlistedResponse = client.execute(new HttpGet("https://localhost:" + mockServerHttpsPort + "/allowlistedresource"));
            assertEquals("Did not receive expected response from mock server for allowlisted url", 200, allowlistedResponse.getStatusLine().getStatusCode());
