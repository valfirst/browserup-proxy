...
public class MostRecentEntryAssertStatusClientErrorRestTest extends BaseRestTest {
    ...
    private int clientErrorStatus = HttpStatus.SC_BAD_REQUEST;
    private int nonClientErrorStatus = HttpStatus.SC_OK;
    private String responseBody = "success";

    @Override
    protected String getUrlPath() { return "har/mostRecentEntry/assertStatusClientError"; }
    ...
    @Test
    public void statusClientErrorPasses() throws Exception {
    ...
    @Test
    public void statusClientErrorFails() throws Exception {
