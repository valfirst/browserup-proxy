...
public interface BrowserMobProxy {
     ...
     * {@link #newHar(String)}. Populates the {@link de.sstoehr.harreader.model.HarPageTiming#onLoad} value based on the amount of time
     ...
     * {@link de.sstoehr.harreader.model.HarPageTiming#onLoad} value based on the amount of time the current page has been captured.
     *
    ...
    /**
     * Stops capturing traffic in the HAR. Populates the {@link de.sstoehr.harreader.model.HarPageTiming#onLoad} value for the current page
